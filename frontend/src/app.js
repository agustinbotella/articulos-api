            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ${complementarios.length > 0 ? `
                        <div class="col-md-6">
                            <strong>Complementarios:</strong><br>
                            ${complementarios.map(id => `<span class="badge badge-complementario me-1">${id}</span>`).join('')}
                        </div>
                    ` : ''}
                    ${sustitutos.length > 0 ? `
                        <div class="col-md-6">
                            <strong>Sustitutos:</strong><br>
                            ${sustitutos.map(id => `<span class="badge badge-sustituto me-1">${id}</span>`).join('')}
                        </div>
                    ` : ''}
                </div>
            </div>
